    ...
    <div class="container">
        ...
        <div class="info-section">
            ...
            <div class="info-content">
                ...
                <p>Дастан бірнеше ғасырлар бойы ауызша тараған. Оны алғаш рет 1831 жылы орыс этнографы А.Фролов жинап, 1841 жылы баспадан шығарған.</p>
                ...
                <p><span class="highlight">Пазл суретінде</span> қазақтың ұлттық киімдерін киген Жібек пен Төлеген, олардың айналасында қазақтың дәстүрлі өмір салты бейнеленген. Суретте ұлттық аспаптар, киіз үй, қымыз ыдыстары, қолөнер бұйымдары көрсетілген.</p>
            </div>
        </div>
    </div>
    ...
    <div class="how-to">
        ...
        <div class="steps">
            ...
            <div class="step">
                ...
                <p>HTML файлын мәтін редакторында ашып, суретті, мәтіндерді өз қалауыңызша өзгертіңіз</p>
            </div>
